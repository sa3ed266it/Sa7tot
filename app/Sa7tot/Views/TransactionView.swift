...
struct TransactionView: View {
    ...
    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.saied.sa7tot")) var topEdge:
    Double = 20
    ...
    @AppStorage(
        "firstTransactionViewLaunch", store: UserDefaults(suiteName: "group.com.saied.sa7tot"))
